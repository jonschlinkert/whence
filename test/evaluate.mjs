...
describe('evaluate', () => {
  describe('ast', () => {
    it('should accept an ast from babel', async () => {
      assert(await e(babel.parseExpression('9 === 9')));
  ...
  describe('sync', () => {
    ...
    describe('ast', () => {
      it('should accept an ast from babel', () => {
        ...
        assert(e.sync(babel.parseExpression('(1 !== 2 || 5 === 5) && "foo" !== true')));
      });

      it('should accept an ast from esprim', () => {
        assert(e.sync(esprima.parse('9 === 9')));
        assert(e.sync(esprima.parse('(1 !== 2 || 5 === 5) && "foo" !== true')));
      });
    });
